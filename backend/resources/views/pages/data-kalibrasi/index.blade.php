...
@section('title', 'Data Kalibrasi | Aplikasi Kalibrasi')
        ...
        <div class="row mt-5">
          <div class="col">
            <div class="d-grid gap-1">
              <a href="{{ route('tambah') }}" class="btn btn-primary w-100">+ Tambah Data </a>
            </div>
          </div>
              ...
              <td class="px-4 align-middle table-center action">
                ...
                <div class="row">
                  <div class="col-8 mx-auto mt-3">
                    <a href="#" class="btn btn-outline-success w-100 mb-4">Detail
                    </a>
                  </div>
                </div>
              </td>
