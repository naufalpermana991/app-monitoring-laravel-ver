...
<head>
  ...
  <title>Kelola Data Laporan || Monitoring Kalibrasi V2.0</title>
  <!-- Favicon-->
  ...
  <div id="page-content-wrapper">
      ...
      <div class="container">
        <div class="navbar-brand">
          <div class="btn btn-back">
            <a class="text-decoration-none" href="{{ route('home') }}"><i data-feather="chevron-left" class="chevron me-3"></i>Kembali</a>
          </div>
        </div>
    ...
    <div class="container mt-5">
      <div class="box-shadow p-5">
        <h4 class="text-center">Formulir Kelola Data Laporan</h4>
        <div class="row">
          <div class="col">
            <div class="mt-5">
